...
<html>
<head>
<title>HWCommander - Banpum Regist</title>
<!-- Required meta tags -->
<meta charset="utf-8">
...
<script type="text/javascript">
    ...
    $(function() {
        $('#btn_banpum_regist').on("click", function () {
        	if(!validationCheck()) {
        		return false;
        	}
...
function goBanpumRegist() {
	
	var form = $("#banpum_regist_form").serialize();
		 
    $.ajax({
        type: "post",
        url: "/admin/banpumRegistLogic.do",
        data: form,
        dataType: 'json',
            ...
            <div id="layoutSidenav_content">
				<main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Banpum Regist</h1>
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item active">Banpum Regist</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-body">
                            	<p class="mb-0">Banpum을  등록합니다.</p>
                            	<p class="mb-0">banpumImage1~15는 자체 클라우드 외부참조링크를 입력하세요.</p>
                            </div>
                        </div>
                        <div class="card mb-4">
							<div class="card-body">
                               <form id="banpum_regist_form">
                                   ...
                                   <div class="mt-4 mb-0">
                                       <div class="d-grid"><a class="btn btn-secondary btn-block" id="btn_banpum_regist">Regist</a></div>
                                   </div>
