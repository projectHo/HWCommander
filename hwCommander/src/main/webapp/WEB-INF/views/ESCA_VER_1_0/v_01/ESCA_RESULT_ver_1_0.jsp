...
<body>
	...
	<div class="basic_background w-100">
		<div class="d-flex">
			...
			<div class="estimateCalc_background container mb-5 mb-lg-0" id="capture-container">
				<div class="row justify-content-center">
					<div class="row w-100">
						<div class="col-md">
							<div class="input-group mb-3 w-100">
								<input type="text" class="form-control pb-0 ps-3 w-fit" id="id-input"aria-label="Text input with checkbox" value="ID : error" style="background-color: #fff;" disabled>
							</div>
						</div>
						<div class="col-md-1 d-lg-block"></div>
						<div class="col-md-2">
							<div class="input-group w-100 result-inputs" style="display: none;">
								<input type="text" class="form-control pb-0 ps-3 w-fit" id="recommender-input" value="추천인 : 오류" style="background-color: #fff;" disabled>
							</div>
						</div>
						<div class="col-md">
							<div class="input-group w-100 result-inputs">
								<input type="text" class="form-control pb-0 ps-3 w-fit" id="date-input"aria-label="Text input with checkbox" value="Date : 0000-00-00" style="background-color: #fff;" disabled>
							</div>
						</div>
					</div>
					<div class="row">
		...
		<div class="mt-5 mx-5 d-none d-lg-block" style="height: 15%!important;">
			<img class="img-fluid float-end" src="/resources/img/layer-34-1200x107.png" alt="">
		</div>
		<div class="mt-2 mx-5 d-none d-lg-block" style="height: 15%!important;">
