...
<html>
  <head>
    ...
    <link
      rel="stylesheet"
      href="/resources/css/estimateCalculationOneCss.css" />
...
function animateBackgroundColor() {
   $(".donut-container").css("background", "conic-gradient(#df22ee 0% "+progress+", #f2f2f2 100% 0%)");
  ...
  <body>
    ...
    <div class="basic_background w-100">
      <div class="d-flex">
        <!-- 빈 영역 -->
        <div
          class="h-25 justify-content-start"
          style="width: 15% !important"></div>
          ...
          <div class="row d-flex">
            <div class="col">
              ...
              <button
                ...
                data-bs-title="0원으로 표기 시 요구사항의 최소 견적으로 자동 산출됩니다.">
                <svg
                  width="40px"
                  height="40px"
                  viewBox="0 -0.5 21 21"
                    ...
                    <g
                      ...
                      <g
                        ...
                        <path
                          ...
                          id="important_message-[#1448]"></path>
                      </g>
                    </g>
                  </g>
                </svg>
            ...
            <div class="col">
              <div class="row">
	            ...
	            <div class="col text-end mt-5 pt-5"><img src="resources/img/purple-stick.png"  /></div>
                
              </div>
              <div class="row">
              	
	            <div class="col text-end"><img src="resources/img/blue-stick.png" /></div>
                
              </div>
              <div class="row">
              	
            	<div class="col text-end"><img src="resources/img/white-stick.png" /></div>
            ...
            <div class="w-75 margin-center">
              <div class="d-flex justify-content-end mb-3">
                <input
                  ...
                  type="text"
                  value="1.본체의 가용 예산 한도는 얼마입니까? (최대 500만원)"
                  readonly
                  aria-label="본체 예상 한도"
                  disabled />
              </div>
              <div
                class="combined-input text-end d-flex flex-end justify-content-end margin-center mb-5">
                <div class="w-50"></div>
                <div class="form-control w-50">
                  <input
                    type="text"
                    class="input-field text-end w-75"
                    placeholder="ex) 300" />
                  <span class="fixed-text w-25">만원</span>
                </div>
              </div>
              <div class="d-flex flex-end justify-content-end">
                <button type="button" class="form-control mb-3 next-btn">
                  다음 질문
                </button>
              </div>
              <div class="d-flex flex-end justify-content-center submit-btn">
                <button type="button" class="form-control w-50">
                  견적 보기
                </button>
              </div>
            </div>
