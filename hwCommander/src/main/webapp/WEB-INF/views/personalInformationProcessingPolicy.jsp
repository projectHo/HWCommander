	...
	<div class="termsOfService_background w-100">
		<div class="d-flex">
			...
			<div class="content pt-5 px-5 mx-5" style="width: 70%!important;">
				...
				<P>■ 개인정보에 관한 민원서비스<br>회사는 고객의 개인정보를 보호하고 개인정보와 관련한 불만을 처리하기 위하여 아래와 같이 관련 부서 및 개인정보보호책임자를 지정하고 있습니다.<br>o 개인정보보호담당자<br>성명 : 이해창<br>소속 : 기술총괄<br>전화번호 : 010-7625-0478<br>이메일 : hwctech1026@gmail.com</P>
				<P>o 개인정보보호책임자<br>성명 : 이해창<br>소속 : 기술총괄<br>전화번호 : 010-7625-0478<br>이메일 : hwctech1026@gmail.com</P>
