...
<script>
    $(function() {
    	...
    	$("#makerListTable").on('click', 'tbody tr', function () {
    		var row = $("#makerListTable").DataTable().row($(this)).data();
    		var id = row[0];
    		location.href = "makerUpdate.do?id="+id;
    	});
    	
        window.addEventListener('unload', function() {
        	setCookie('displayLength', $("select[name=makerListTable_length]").val(), {'max-age': 1800});
       	});
    });
</script>
            ...
            <div id="layoutSidenav_content">
				<main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">MAKER</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="main.do">Admin Page</a></li>
                            <li class="breadcrumb-item active">MAKER</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-body">
                                MAKER를 관리합니다. 조회, 추가, 수정 작업을 할 수 있습니다.
                            </div>
                        </div>
                        <div class="card mb-4">
                            <div class="card-header">
								<div class="d-flex">
								  <div class="me-auto d-flex align-items-center">Search MAKER</div>
								  <div>
								  	<a class="btn btn-secondary btn-sm" href="makerRegist.do">등록</a>
								  </div>
								</div>
                            </div>
                            <div class="card-body">
                                <table id="makerListTable" class="table">
                                    <thead>
                                        <tr>
                                            <th>id</th>
                                            <th>Maker Name</th>
