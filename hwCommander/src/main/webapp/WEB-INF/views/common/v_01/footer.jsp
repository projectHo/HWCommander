...
<body>
	<div class="footer_background w-100">
		<div class="d-flex">
			<!-- 빈 영역 -->
			<div class="h-25 justify-content-start" style="width: 15%!important;"></div>
			<div class="" style="width: 70%!important;">
				<div class="w-100 row align-items-center py-5 text-nowrap gap-3">
	...
	<div class="basic_background w-100">
		<div class="d-flex">
			...
			<div class="w-auto w-lg-70 px-sm-5 px-md-0">
				<div class="w-100 row align-items-center mt-4 pb-5 mb-5 mb-xl-0 mx-auto gap-4 gap-lg-0">
					<div class="col">
						<div class="d-flex justify-content-center">
							...
							<!-- 2023.05.20 로고수정
								<img width="300" height="167" src="/resources/img/cropped-cpLogo-300x167.png">
								 -->
								<img class="mb-3 mb-md-0" width="274" height="190" src="/resources/img/comlogo09-821x569.png">
							</a>
						</div>
						<div class="d-flex justify-content-center">
						...
						<div class="d-flex justify-content-center">
							<p class="fs-6" style="margin-bottom:0;important;">판매되는 모든 상품은 HWCommander에서 책임지고 있습니다.</p>
						</div>
						<div class="d-flex justify-content-center">
							<p class="fs-6" style="margin-bottom:0;important;">* 민원 담당자 이해창 / 연락처 010-7625-0478</p>
						</div>
						<div class="d-flex justify-content-center">
							<p class="fs-6" style="margin-bottom:0;important;">HWCommander에서 운영하는 사이트에서</p>
						</div>
					</div>
					<div class="col-md">
						<nav class="nav flex-column">
			...
			<!-- 빈 영역 -->
			<div class="justify-content-end w-lg-15"></div>
		</div>
	</div>
</body>
</html>
