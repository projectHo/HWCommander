	...
	<div class="termsOfService_background w-100">
		<div class="d-flex">
			...
			<div class="content pt-5 px-5 mx-5" style="width: 70%!important;">
				...
				<ul>
					<li>회원가입시 : 이름 ,로그인ID ,비밀번호 ,휴대전화번호 , 이메일</li>
				...
				<ul>
					<li>홈페이지, 서면양식, 게시판, 이메일, 배송요청, 전화를 통한 수집</li>
				</ul>
				
				<P>■ 개인정보의 수집 및 이용목적<br>회사는 수집한 개인정보를 다음의 목적을 위해 활용합니다.<br>o 서비스 제공에 관한 계약 이행 및 서비스 제공에 따른 요금정산<br>구매 및 요금 결제 , 물품배송 또는 청구지 등 발송 , 전자거래 본인 인증<br>o 회원 관리<br>회원제 서비스 이용에 따른 본인확인 , 개인 식별 , 불량회원의 부정 이용 방지와 비인가 사용 방지 , 가입 의사 확인, 불만처리 등 민원처리 , 고지사항 전달<br>o 마케팅 및 광고에 활용<br>이벤트 등 광고성 정보 전달 , 접속 빈도 파악 또는 회원의 서비스 이용에 대한 통계</P>
				<P>■ 개인정보의 보유 및 이용기간<br>원칙적으로, 개인정보 수집 및 이용목적이 달성된 후에는 해당 정보를 지체 없이 파기합니다. 단, 다음의 정보에 대해서는 아래의 이유로 명시한 기간 동안 보존합니다.</P>
				<P>가. 회사 내부방침에 의한 정보보유 사유<br>회원이 탈퇴한 경우에도 불량회원의 부정한 이용의 재발을 방지, 분쟁해결 및 수사기관의 요청에 따른 협조를 위하여, 이용계약 해지일로부터 3년간 회원의 정보를 보유할 수 있습니다.</P>
				...
				<P>■ 개인정보에 관한 민원서비스<br>회사는 고객의 개인정보를 보호하고 개인정보와 관련한 불만을 처리하기 위하여 아래와 같이 관련 부서 및 개인정보보호책임자를 지정하고 있습니다.<br>o 개인정보보호담당자<br>성명 : 강현우<br>소속 : 기술총괄<br>전화번호 : 010-7625-0478<br>이메일 : hwctech1026@gmail.com</P>
				<P>o 개인정보보호책임자<br>성명 : 강현우<br>소속 : 기술총괄<br>전화번호 : 010-7625-0478<br>이메일 : hwctech1026@gmail.com</P>
