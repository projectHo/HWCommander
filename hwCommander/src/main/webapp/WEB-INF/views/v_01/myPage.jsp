...
<script>
	...
	function deliveryListTest(){
		$.ajax({
			type: "post",
			url: "/user/deliveryListRegistLogic.do",
			data: {
				userId: "${loginUser.id}",
				postalCode: "12321",
				roadAddress: "도로명주소테스트",
				jibunAddress: "지번주소테스트",
				detailAddress: "상세주소 테스트",
				deliveryStatus: "지워도 될거같은",
				listName: "배송지 이름"
			},
			dataType: "json",
			success: function() {
								...
								<div id="flush-collapseOne" class="accordion-collapse collapse show" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
									<div class="accordion-body">
										<div class="list-group list-group-flush">
											...
											<a href="javascript:void(0)" class="list-group-item list-group-item-action" onclick="javascript:deliveryListTest()">
												배송지 관리(주소록)
											</a>
