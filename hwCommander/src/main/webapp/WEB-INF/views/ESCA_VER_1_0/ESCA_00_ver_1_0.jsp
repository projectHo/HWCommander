			...
			<div class="esca-box">
				...
				<div class="d-flex">
					<div class="d-flex flex-column gap-2 p-4 w-25 esca-left-side">
						...
						<button type="button" class="btn position-relative btn-outline-secondary border-0 text-start fw-bold px-4 ms-2" question="04" onclick="javascript:questionBtns(this)">질문 04</button>
