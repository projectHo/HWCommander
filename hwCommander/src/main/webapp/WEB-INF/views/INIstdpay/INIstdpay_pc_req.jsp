                ...
                <div class="card">
                    ...
                    <form name="" id="SendPayForm_id" method="post" class="mt-5">
                        <div class="row g-3 justify-content-between" style="--bs-gutter-x:0rem;">
				    		...
				    		<input type="hidden" name="returnUrl" value="https://localhost:8080/INIstdpay_pc_return.jsp">
                            <input type="hidden" name="closeUrl" value="https://localhost:8080/close.jsp">
