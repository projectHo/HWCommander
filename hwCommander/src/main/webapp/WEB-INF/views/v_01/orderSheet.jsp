...
<link rel="stylesheet" href="/resources/css/orderSheet.css">
...
<script>
    $(function() {
		...
		if(width < 1440) {
			$(".goni-wrap").addClass("d-none");
			$(".col-form-label").addClass("pb-0");
			$(".d-pc").remove();
	...
	<form id="order_sheet_form">
		<div class="mx-auto container pt-3 pb-3">
			<div class="card mt-4">
				...
				<div class="card-body pb-0 d-mobile">
					<table id="productListInfoTable" class="table">
						<thead>
							<tr>
								<th></th>
							...
							<c:if test="${accessRoute == 'banpum'}">
								<tr class="order-items">
									<td>
										...
										--%>
										<!-- 이미지 추가 방식 변경예정 -->
										<div id="banpumMallOrderIndicators" class="carousel carousel-dark slide" data-bs-ride="true" style="width:100%; height:280px; object-fit:contain;">
											<div class="carousel-indicators">
												<button type="button" data-bs-target="#banpumMallOrderIndicators" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1"></button>
												<c:forEach var="i" begin="2" end="15">
													<c:set var="key" value="banpumImage${i}" />
										...
										<!-- <p class="align-middle text-center"> -->
											...
											<p class="fs-4 mb-0">주문 내역</p>
											<div class="p-2 border-top border-bottom mb-2 mt-2">
												<p class="ps-2 pe-2">상품 가격 : ${orderQtys}개, 개당 ${banpumMasterVO.banpumPriceStr}</p>
												<p class="ps-2 pe-2 mb-0">박스 추가 : ${boxQtys}개, 총 ${boxTotPrice}원</p>
											</div>
											<h3 class="mb-0"> 총 금액 : ${totOrderPriceStr}원</h3>
			...
			<div class="card mb-4">
				...
				<div class="card-body pb-0">
					...
					<div class="mb-md-3 row d-md-flex">
...
<form id="inicisSendFormM" method="post" name="mobileweb" action="https://mobile.inicis.com/smart/payment/" target="_self">
