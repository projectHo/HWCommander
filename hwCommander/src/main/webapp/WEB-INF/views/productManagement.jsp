...
<html>
<head>
<title>HWCommander - Product</title>
<!-- Required meta tags -->
<meta charset="utf-8">
<!-- Bootstrap CSS -->
...
<script>
    $(function() {
        ...
        window.addEventListener('unload', function() {
        	setCookie('displayLength', $("select[name=productListTable_length]").val(), {'max-age': 1800});
       	});
    });
</script>
            ...
            <div id="layoutSidenav_content">
				<main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                Product를 관리합니다. 조회, 추가, 수정 작업을 할 수 있습니다.
                            </div>
                        </div>
                        <div class="card mb-4">
                            <div class="card-header">
								<div class="d-flex">
								  <div class="me-auto d-flex align-items-center">Search Product</div>
								  <div>
								  	<a class="btn btn-secondary btn-sm" href="productRegist.do">등록</a>
								  </div>
								</div>
                            </div>
                            <div class="card-body">
