...
<script>
    $(function() {
        ...
        window.addEventListener('unload', function() {
        	setCookie('displayLength', $("select[name=sfListTable_length]").val(), {'max-age': 1800});
       	});
    });
</script>
            ...
            <div id="layoutSidenav_content">
				<main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                SF를 관리합니다. 조회, 추가, 수정 작업을 할 수 있습니다.
                            </div>
                        </div>
                        <div class="card mb-4">
                            <div class="card-header">
								<div class="d-flex">
								  <div class="me-auto d-flex align-items-center">Search SF</div>
								  <div>
								  	<a class="btn btn-secondary btn-sm" href="sfRegist.do">등록</a>
								  </div>
								</div>
                            </div>
                            <div class="card-body">
                                <table id="sfListTable" class="table">
                                    <thead>
                                        <tr>
                                            <th>parts name</th>
                                            <th>parts price</th>
