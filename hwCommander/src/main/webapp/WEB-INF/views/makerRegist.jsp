...
<html>
<head>
<title>HWCommander - MAKER Regist</title>
<!-- Required meta tags -->
<meta charset="utf-8">
<!-- Bootstrap CSS -->
...
function goMakerRegist() {
    var form = $("#maker_regist_form").serialize();
    
    $.ajax({
        type: "post",
        url: "/admin/makerRegistLogic.do",
        data: form,
        dataType: 'json',
