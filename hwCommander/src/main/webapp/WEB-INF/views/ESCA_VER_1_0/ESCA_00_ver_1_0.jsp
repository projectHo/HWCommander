								...
								<div class="mt-2 mb-5 row">
									<div class="col-md">
										<div class="input-group has-validation text-end d-flex flex-end justify-content-center mb-5 calc-input-element">
											<input type="text" class="form-control input-field text-end w-50 first-q-input fs-5 pt-2" min="0" max="500" placeholder="ex) 250" id="can-pay-val" aria-describedby="inputGroupPrepend" required oninput="javascript:questionTwoBtns(this)"/>
