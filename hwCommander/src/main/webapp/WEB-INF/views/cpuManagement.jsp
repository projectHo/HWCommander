...
<script>
    $(function() {
        ...
        window.addEventListener('unload', function() {
        	setCookie('displayLength', $("select[name=cpuListTable_length]").val(), {'max-age': 1800});
       	});
    });
</script>
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
								<div class="d-flex">
								  <div class="me-auto d-flex align-items-center">Search CPU</div>
								  <div>
								  	<a class="btn btn-secondary btn-sm" href="cpuRegist.do">등록</a>
								  </div>
								</div>
                            </div>
                            <div class="card-body">
                                <table id="cpuListTable" class="table">
                                    <thead>
                                        <tr>
                                            <th>parts name</th>
                                            <th>parts price</th>
