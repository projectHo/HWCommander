...
<html>
<head>
<title>HWCommander - Cooler</title>
<!-- Required meta tags -->
<meta charset="utf-8">
<!-- Bootstrap CSS -->
...
<script>
    $(function() {
    	...
    	$("#coolerListTable").on('click', 'tbody tr', function () {
    		var row = $("#coolerListTable").DataTable().row($(this)).data();
    		var partsId = row[6];
    		location.href = "coolerUpdate.do?partsId="+partsId;
    	});
    	
        window.addEventListener('unload', function() {
        	setCookie('displayLength', $("select[name=coolerListTable_length]").val(), {'max-age': 1800});
       	});
    });
</script>
