...
<link rel="stylesheet" href="/resources/css/ver_02/termsOfService.css">
...
<body>
	...
	<div class="terms-of-service-body py-5">
		<div class="d-flex flex-column gap-5 justify-content-center align-items-center mx-auto container">
			<h1 class="text-white fw-bold">이용 약관</h1>
			<div class="terms-of-service-boxs p-5 text-white">
