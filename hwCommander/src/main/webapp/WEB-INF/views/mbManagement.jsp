...
<script>
    $(function() {
        ...
        window.addEventListener('unload', function() {
        	setCookie('displayLength', $("select[name=mbListTable_length]").val(), {'max-age': 1800});
       	});
    });
</script>
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
								<div class="d-flex">
								  <div class="me-auto d-flex align-items-center">Search MB</div>
								  <div>
								  	<a class="btn btn-secondary btn-sm" href="mbRegist.do">등록</a>
								  </div>
								</div>
                            </div>
                            <div class="card-body">
                                <table id="mbListTable" class="table">
                                    <thead>
                                        <tr>
                                            <th>parts name</th>
                                            <th>parts price</th>
