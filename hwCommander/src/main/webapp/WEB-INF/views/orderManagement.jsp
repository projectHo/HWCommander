...
<script>
    $(function() {
    	...
    	$("#orderListTable").on('click', 'tbody tr', function () {
    		var row = $("#orderListTable").DataTable().row($(this)).data();
    		var id = row[0];
    		location.href = "orderDetail.do?id="+id;
    	});
    	
        window.addEventListener('unload', function() {
        	setCookie('displayLength', $("select[name=orderListTable_length]").val(), {'max-age': 1800});
       	});
    });
</script>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="orderListTable" class="table">
                                    ...
                                    <tbody>
										<c:forEach var="item" items="${orderMasterList}">
											<tr>
	                                            <td>${item.id}</td>
